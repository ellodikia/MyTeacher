...
<head>
    ...
    <title>Dashboard Guru - MYTEACHER</title>
    ...
    <div class="flex-1 flex flex-col min-w-0">
        ...
        <main class="p-6 md:p-8 lg:p-10">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="mb-10">
                    <h1 class="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight">Selamat Datang, Guru 👋</h1>
                ...
                <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-200 overflow-hidden">
                    <div class="p-8 border-b border-slate-50 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        ...
                        <a href="daftar_nilai.php" class="text-blue-600 font-bold text-sm hover:underline flex items-center gap-2">
                            ...
                            <tbody class="divide-y divide-slate-50">
                                <?php if(mysqli_num_rows($query_latest) > 0): ?>
                                    ...
                                    <tr class="hover:bg-slate-50/50 transition-colors group">
                                        ...
                                        <td class="px-8 py-5">
                                            <span class="text-slate-500 font-medium"><?= $row['mata_pelajaran'] ?></span>
                                        </td>
                                        <td class="px-8 py-5">
                                        ...
                                        <td class="px-8 py-5 text-center">
                                            <?php if($isPass): ?>
                                                <span class="inline-flex bg-emerald-50 text-emerald-600 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-tighter border border-emerald-100">
                                                    Tuntas
                                                </span>
                                            <?php else: ?>
                                                <span class="inline-flex bg-red-50 text-red-600 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-tighter border border-red-100">
                                                    Remedial
                                                </span>
                                            <?php endif; ?>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="4" class="px-8 py-20 text-center">
                                            <div class="flex flex-col items-center justify-center opacity-40">
                                                ...
                                                <p class="font-bold">Belum ada data nilai yang diinput.</p>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endif; ?>
